...
namespace HotelManagementSystem
{
    public partial class staffMainForm : Form
    {
        ...
        {
            if (MessageBox.Show("Bạn có muốn đăng xuất không?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
        ...
        {
            if (MessageBox.Show("Bạn có muốn thoát không?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                Application.Exit();
            }
        }
